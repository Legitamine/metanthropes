...
export async function MetapowerRollStat(
	...
	<button class="metapower-re-roll" data-idactor="${actor.id}" data-stat="${stat}" data-stat-value="${statValue}"
	...
	🤞</button>
	<button class="metapower-activate" data-idactor="${actor.id}" data-stat="${stat}" data-stat-value="${statValue}"
