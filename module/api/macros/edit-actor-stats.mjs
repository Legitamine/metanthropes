/**
 * Macro: Narrator's Toolbox - Edit Actor Stats
 *
 * @export
 * @async
 * @param {string} actorType - The actorType to edit, eg "Protagonist", "Metanthrope", etc
 * @returns {*}
 */
export async function editActorStats(actorType) {
	if (!game.user.isGM) {
...
`;
	...
	dialogContent += `<div>Confirming will set the Actors' Current Life to their Max Life</div><br><br>`;
	let dialogOptions = {
		width: 1250,
		height: 720,
		resizable: true,
	...
	let toolboxdialog = new Dialog(
		{
			title: `Narrator's Toolbox - Edit ${actorType} Stats`,
