 ...
 * 
 *
 * todo:  review d100 roll usage & we should return to update the existing message, like in metad10
 *
 * @param {*} actor
 * @param {*} coverType
 * @param {*} coverValue
...
/**
 * Cover ReRoll
 *	todo: we should return to update the existing message, like in metad10
 * @param {*} event
 */
