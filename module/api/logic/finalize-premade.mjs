...
export async function metaNewPremadeSummary(actor) {
	...
	let dialogContent = `
		<div class="metanthropes layout-metaroll-dialog">
			<h3>Choose your ${actor.type}'s <i class="fa-duotone fa-solid fa-id-card"></i> Summary</h3>
			<form>
	...
	return new Promise((resolve, reject) => {
		let dialog = new Dialog({
			title: `Finalize Premade: ${actor.type} <i class="fa-duotone fa-solid fa-id-card"></i> Summary`,
			content: dialogContent,
			buttons: {
				ok: {
					label: `"Confirm <i class="fa-duotone fa-solid fa-id-card"></i> Summary`,
					callback: async (html) => {
