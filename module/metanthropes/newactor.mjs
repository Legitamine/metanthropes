...
import { metaActorControl } from "./actorcontrol.mjs";
...
export async function NewStatRoll(actor, char, stat, dice) {
	return new Promise((resolve, reject) => {
		metaRolld10(actor, stat, true, dice, null, 0, false);
		let statcontent = `
				...
				buttons: {
					ok: {
						...
						callback: async (html) => {
							...
							await metaRolld10(actor, "Destiny", false, destinydice);
