...
export async function MetaStartProgression(metaProgressionActor) {
	new MetanthropesActorProgressionSheet(metaProgressionActor).render(true);
}

// export async function openProgressionForm(metaProgressionActor) {
// 	metaLog(3, "openProgressionForm", "Engaged for metaProgressionActor:", metaProgressionActor);
...
// 		//					);
// 		//				} catch (error) {
// 		//					metaLog(5, "openProgressionForm", "Error occurred:", error);
// 		//				}
// 		//			},
// 		//		},
// 		//		reset: {
...
// 	};
// 	const formData = {
// 		progressionActor: metaProgressionActor,
// 		buttons: formButtons,
// 		content: formContent,
// 		title: `${metaProgressionActor.name}'s 📈 Progression`,
// 	};
// 	metaLog(
// 		3,
// 		"openProgressionForm",
...
// export class MetanthropesProgressionForm extends MetanthropesActorSheet {
...
// 		metaLog(5, "MetanthropesProgressionForm", "prepareDerivedData", "this:", this);
// 	}
